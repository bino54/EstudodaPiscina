...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"aeb03282-49d9-40e8-b57d-9cd5ca7df3a1\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [30 x i8] c"com.companyname.estudopiscina\00", align 16
...
@__DSOCacheEntry_name.30 = internal constant [28 x i8] c"libaot-EstudoPiscina.dll.so\00", align 16
@__DSOCacheEntry_name.31 = internal constant [41 x i8] c"libaot-Xamarin.AndroidX.ViewPager.dll.so\00", align 16
@__DSOCacheEntry_name.32 = internal constant [36 x i8] c"libaot-CommunityToolkit.Mvvm.dll.so\00", align 16
@__DSOCacheEntry_name.33 = internal constant [41 x i8] c"libaot-Xamarin.AndroidX.AppCompat.dll.so\00", align 16
@__DSOCacheEntry_name.34 = internal constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 16
@__DSOCacheEntry_name.35 = internal constant [44 x i8] c"libaot-System.Collections.NonGeneric.dll.so\00", align 16
@__DSOCacheEntry_name.36 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.ViewPager2.dll.so\00", align 16
@__DSOCacheEntry_name.37 = internal constant [62 x i8] c"libaot-Microsoft.Extensions.Configuration.Abstractions.dll.so\00", align 16
@__DSOCacheEntry_name.38 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.SavedState.dll.so\00", align 16
@__DSOCacheEntry_name.39 = internal constant [55 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.LiveData.Core.dll.so\00", align 16
@__DSOCacheEntry_name.40 = internal constant [43 x i8] c"libaot-Microsoft.Maui.Controls.Xaml.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 30
	%struct.DSOCacheEntry {
		i64 1166955693153774871, ; hash 0x1031dc05270ced17, from name: EstudoPiscina
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.30, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 31
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__DSOCacheEntry_name.37, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 39
	%struct.DSOCacheEntry {
	...
	; 140
	%struct.DSOCacheEntry {
		i64 6549476506817617971, ; hash 0x5ae46a2eada16033, from name: aot-EstudoPiscina.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.30, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 257
	%struct.DSOCacheEntry {
		i64 10773974977389905252, ; hash 0x9584d928b245c564, from name: libaot-EstudoPiscina
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.30, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 264
	%struct.DSOCacheEntry {
		i64 11145579794928033768, ; hash 0x9aad0dc58c74dfe8, from name: libaot-EstudoPiscina.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.30, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 438
	%struct.DSOCacheEntry {
		i64 17638752667313242455, ; hash 0xf4c97018c82e0157, from name: EstudoPiscina.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.30, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 443
	%struct.DSOCacheEntry {
		i64 17817582194548115821, ; hash 0xf744c49ab65d896d, from name: aot-EstudoPiscina
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.30, i32 0, i32 0), ; name
		i8* null; handle
	}, 

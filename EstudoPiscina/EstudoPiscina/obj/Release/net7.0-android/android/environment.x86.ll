...
@__DSOCacheEntry_name.9 = internal constant [28 x i8] c"libaot-EstudoPiscina.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 8
	%struct.DSOCacheEntry {
		i64 136801472, ; hash 0x8276cc0, from name: aot-EstudoPiscina
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 9
	%struct.DSOCacheEntry {
	...
	; 147
	%struct.DSOCacheEntry {
		i64 1396496513, ; hash 0x533cd881, from name: aot-EstudoPiscina.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 164
	%struct.DSOCacheEntry {
		i64 1556248655, ; hash 0x5cc2784f, from name: EstudoPiscina.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 194
	%struct.DSOCacheEntry {
		i64 1879432931, ; hash 0x7005dee3, from name: libaot-EstudoPiscina.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 313
	%struct.DSOCacheEntry {
		i64 2859659181, ; hash 0xaa72efad, from name: libaot-EstudoPiscina
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 362
	%struct.DSOCacheEntry {
		i64 3238888892, ; hash 0xc10d85bc, from name: EstudoPiscina
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.9, i32 0, i32 0), ; name
		i8* null; handle
	}, 
